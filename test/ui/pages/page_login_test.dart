...
void main() {
  ...
  testWidgets('Should present no error if email is empty', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should present no error if password is empty', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should present error message if authetication fails', (WidgetTester tester) async {
    await loadPage(tester);
