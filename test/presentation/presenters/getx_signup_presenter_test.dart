...
void main() {
  ...
  test('Should call Validation with correct passwordConfirmation', () {
    ...
    verify(validation.validate(field: 'passwordConfirmation', value: passwordConfirmation))
        .called(1);
  });
  ...
  test('Should emit UnexpectedError if SaveCurrentAccount fails', () async {
    ...
    sut.mainErrorStream.listen((error) => expect(error, UIError.unexpected));
  ...
  test('Should emit correct events on EmailInUseError', () async {
    ...
    sut.mainErrorStream.listen((error) => expect(error, UIError.emailInUse));
